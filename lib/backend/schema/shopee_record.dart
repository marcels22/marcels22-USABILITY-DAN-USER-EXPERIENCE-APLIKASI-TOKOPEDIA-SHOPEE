...
class ShopeeRecord extends FirestoreRecord {
  ShopeeRecord._(
    super.reference,
    super.data,
  ) {
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('shopee');

  static Stream<ShopeeRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => ShopeeRecord.fromSnapshot(s));

  static Future<ShopeeRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => ShopeeRecord.fromSnapshot(s));

  static ShopeeRecord fromSnapshot(DocumentSnapshot snapshot) => ShopeeRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static ShopeeRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      ShopeeRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'ShopeeRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is ShopeeRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createShopeeRecordData({
  double? mengganggu,
...
class ShopeeRecordDocumentEquality implements Equality<ShopeeRecord> {
  const ShopeeRecordDocumentEquality();

  @override
  bool equals(ShopeeRecord? e1, ShopeeRecord? e2) {
  ...
  @override
  int hash(ShopeeRecord? e) => const ListEquality().hash([
        e?.mengganggu,
  ...
  @override
  bool isValidKey(Object? o) => o is ShopeeRecord;
}
