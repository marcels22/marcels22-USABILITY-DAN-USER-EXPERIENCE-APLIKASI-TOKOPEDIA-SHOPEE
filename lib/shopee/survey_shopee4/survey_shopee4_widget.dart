...
import 'survey_shopee4_model.dart';
export 'survey_shopee4_model.dart';

class SurveyShopee4Widget extends StatefulWidget {
  const SurveyShopee4Widget({super.key});

  @override
  State<SurveyShopee4Widget> createState() => _SurveyShopee4WidgetState();
}

class _SurveyShopee4WidgetState extends State<SurveyShopee4Widget>
    with TickerProviderStateMixin {
  late SurveyShopee4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SurveyShopee4Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed('surveyShopee5');
                      },
                      text: 'Selanjutnya',
