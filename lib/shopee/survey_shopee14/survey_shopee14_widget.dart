...
import 'survey_shopee14_model.dart';
export 'survey_shopee14_model.dart';

class SurveyShopee14Widget extends StatefulWidget {
  const SurveyShopee14Widget({super.key});

  @override
  State<SurveyShopee14Widget> createState() => _SurveyShopee14WidgetState();
}

class _SurveyShopee14WidgetState extends State<SurveyShopee14Widget>
    with TickerProviderStateMixin {
  late SurveyShopee14Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SurveyShopee14Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed('surveyShopee15');
                      },
                      text: 'Selanjutnya',
