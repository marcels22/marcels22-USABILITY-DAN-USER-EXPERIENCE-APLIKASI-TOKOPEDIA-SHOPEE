...
import 'survey_shopee21_model.dart';
export 'survey_shopee21_model.dart';

class SurveyShopee21Widget extends StatefulWidget {
  const SurveyShopee21Widget({super.key});

  @override
  State<SurveyShopee21Widget> createState() => _SurveyShopee21WidgetState();
}

class _SurveyShopee21WidgetState extends State<SurveyShopee21Widget>
    with TickerProviderStateMixin {
  late SurveyShopee21Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SurveyShopee21Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed('surveyShopee22');
                      },
                      text: 'Selanjutnya',
