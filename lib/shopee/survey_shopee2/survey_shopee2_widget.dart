...
import 'survey_shopee2_model.dart';
export 'survey_shopee2_model.dart';

class SurveyShopee2Widget extends StatefulWidget {
  const SurveyShopee2Widget({super.key});

  @override
  State<SurveyShopee2Widget> createState() => _SurveyShopee2WidgetState();
}

class _SurveyShopee2WidgetState extends State<SurveyShopee2Widget>
    with TickerProviderStateMixin {
  late SurveyShopee2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SurveyShopee2Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed('surveyShopee3');
                      },
                      text: 'Selanjutnya',
