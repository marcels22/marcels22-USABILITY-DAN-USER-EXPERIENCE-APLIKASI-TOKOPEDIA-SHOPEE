...
import 'survey_shopee7_model.dart';
export 'survey_shopee7_model.dart';

class SurveyShopee7Widget extends StatefulWidget {
  const SurveyShopee7Widget({super.key});

  @override
  State<SurveyShopee7Widget> createState() => _SurveyShopee7WidgetState();
}

class _SurveyShopee7WidgetState extends State<SurveyShopee7Widget>
    with TickerProviderStateMixin {
  late SurveyShopee7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SurveyShopee7Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed('surveyShopee8');
                      },
                      text: 'Selanjutnya',
