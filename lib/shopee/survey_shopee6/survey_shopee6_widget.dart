...
import 'survey_shopee6_model.dart';
export 'survey_shopee6_model.dart';

class SurveyShopee6Widget extends StatefulWidget {
  const SurveyShopee6Widget({super.key});

  @override
  State<SurveyShopee6Widget> createState() => _SurveyShopee6WidgetState();
}

class _SurveyShopee6WidgetState extends State<SurveyShopee6Widget>
    with TickerProviderStateMixin {
  late SurveyShopee6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SurveyShopee6Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed('surveyShopee7');
                      },
                      text: 'Selanjutnya',
