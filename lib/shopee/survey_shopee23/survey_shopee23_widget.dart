...
import 'survey_shopee23_model.dart';
export 'survey_shopee23_model.dart';

class SurveyShopee23Widget extends StatefulWidget {
  const SurveyShopee23Widget({super.key});

  @override
  State<SurveyShopee23Widget> createState() => _SurveyShopee23WidgetState();
}

class _SurveyShopee23WidgetState extends State<SurveyShopee23Widget>
    with TickerProviderStateMixin {
  late SurveyShopee23Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SurveyShopee23Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed('surveyShopee24');
                      },
                      text: 'Selanjutnya',
