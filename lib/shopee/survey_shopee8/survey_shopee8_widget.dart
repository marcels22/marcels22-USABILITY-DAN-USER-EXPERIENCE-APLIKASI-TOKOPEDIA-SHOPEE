...
import 'survey_shopee8_model.dart';
export 'survey_shopee8_model.dart';

class SurveyShopee8Widget extends StatefulWidget {
  const SurveyShopee8Widget({super.key});

  @override
  State<SurveyShopee8Widget> createState() => _SurveyShopee8WidgetState();
}

class _SurveyShopee8WidgetState extends State<SurveyShopee8Widget>
    with TickerProviderStateMixin {
  late SurveyShopee8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SurveyShopee8Model());
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed('surveyShopee9');
                      },
                      text: 'Selanjutnya',
